...
if __name__ == "__main__":
    ...
    if not Path("./mushroom.test.csv").exists():
        convert_files(Path("./mushroom.test"))
    if not Path("./mushroom.training.csv").exists():
        convert_files(Path("./mushroom.training"))

    train_file = Path("./mushroom.training.csv")
    test_file = Path("./mushroom.test.csv")
